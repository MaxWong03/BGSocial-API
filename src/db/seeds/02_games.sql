...
(
        ...
        1, --bgg_id
        7.6246, --rating
        'https://cf.geekdo-images.com/thumb/img/Y2pmp3_tPmiyJ032upHBwqD49xM=/fit-in/200x150/pic4718279.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/uqlrq_bQJqHpcaN7_7qocV5XfbU=/0x0/pic4718279.jpg', --image
        'Economic, Negotiation, Political', --category
        'Area Majority / Influence, Auction/Bidding, Dice Rolling, Hand Management, Simultaneous Action Selection') --mechanic
,
(
        2, --id
        'Dragonmaster', --name
...
(
        ...
        3, --bgg_id
        7.44068, --rating
        'https://cf.geekdo-images.com/thumb/img/BOzp5hzTDSHjXf0yijvREDXxQos=/fit-in/200x150/pic3211873.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/mPS50ts53753q5-kb5vWbTDN8Z0=/0x0/pic3211873.jpg', --image
        'Abstract Strategy, Medieval', --category
        'Area Majority / Influence, Hand Management, Set Collection, Tile Placement') --mechanic
,
(
        4, --id
        'Tal der Könige', --name
        'When you see the triangular box and the luxurious, large blocks, you can tell this game was designed to be beautiful as well as functional.  The object of the game is to build pyramids out of the different colored blocks.  A pyramid scores more points when its made from a few colors, but its much harder to consistently outbid the other players for the necessary blocks.  The game is over when the Pharoahs Pyramid in the center is completed, which is built using all the blocks that the players dont use during the course of the game.Final round 1990 Hippodice Spieleautorenwettbewerb.', --description
        1992, --year_published
        12, --age
        60, --play_time_min
        60, --play_time_max
        4, --bgg_id
        6.60804, --rating
        'https://cf.geekdo-images.com/thumb/img/aqEMohPTNBbRO84X7J5tq3dirBk=/fit-in/200x150/pic285299.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/TgcSkyM0Stk6Xz4ZahXrhpVfjm8=/0x0/pic285299.jpg', --image
        'Ancient', --category
        'Action Points, Area Majority / Influence, Auction/Bidding, Set Collection') --mechanic
,
(
        5, --id
        'Acquire', --name
        ...
        5, --bgg_id
        7.34843, --rating
        'https://cf.geekdo-images.com/thumb/img/ZODhu5g13HRQEcOgMP8oiRooQQc=/fit-in/200x150/pic3299296.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/Bz4tTHNpq6gUKFkJs0fJdVIGR1s=/0x0/pic3299296.jpg', --image
        'Economic', --category
        'Hand Management, Investment, Market, Ownership, Stock Holding, Tile Placement') --mechanic
,
(
        6, --id
        'Mare Mediterraneum', --name
        'In the ancient lands along the Mediterranean, players attempt to satisfy their unique victory conditions via trade, war and construction.  This lavishly produced game contains tons of wooden game components and a beautiful roll-out vinyl map.  Players produce a score of different commodities to trade with other cities in the hope of creating enough income to fill their capitals with buildings, produce artwork, and fill warehouses with goods.', --description
        1989, --year_published
        12, --age
        240, --play_time_min
        240, --play_time_max
...
(
        ...
        7, --bgg_id
        6.51326, --rating
        'https://cf.geekdo-images.com/thumb/img/_o2Qy_RXfWQs7gaIwwsB3l6oEJU=/fit-in/200x150/pic181642.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/Gri8ET3BFLE6mzdQLyWZnjWv25s=/0x0/pic181642.jpg', --image
        'Abstract Strategy', --category
        'Enclosure, Pattern Building, Pattern Recognition, Tile Placement') --mechanic
,
(
        8, --id
        'Lords of Creation', --name
        'In this interesting offering from Warfrog, players become Gods seeking to dominate a world with their followers.  The first part of the game involves constructing the game board, after which players take turns using cards to determine how many new people should appear and what type of terrain they will inhabit.  All tribes start off as barbarians, but soon the calming effect of civilization settles the marauding bands; although civilized tribes score more, they can no longer attack.  What they can do, though, is civilize other players followers.  Sure it gives opponents more points, but at least those followers wont come after you!', --description
        1993, --year_published
        12, --age
        120, --play_time_min
        120, --play_time_max
...
(
        ...
        10, --bgg_id
        6.72701, --rating
        'https://cf.geekdo-images.com/thumb/img/eqDi6VPAU3XUvDDhqur97X2umO0=/fit-in/200x150/pic1798136.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/M3fRcs2sKpffc7Yl1KXodvbBa5Q=/0x0/pic1798136.jpg', --image
        'Fantasy, Travel', --category
        'Card Drafting, Hand Management, Network and Route Building, Point to Point Movement') --mechanic
,
(
        11, --id
        'Bohnanza', --name
        'Bohnanza is the first in the Bohnanza family of games and has been published in several different editions.The cards are colorful depictions of beans in various descriptive poses, and the object is to make coins by planting fields (sets) of these beans and then harvesting them.  To help players match their cards up, the game features extensive trading and deal making.  One of the most unique features of the game is that you cannot rearrange your hand, as you need to play the cards in the order that you draw them.The original German edition supports 3-5 players.The English version from Rio Grande Games comes with the first edition of the first German expansion included in a slightly oversized box.  One difference in the contents, however, is that bean #22s Weinbrandbohne (Brandy Bean) was replaced by the Wachsbohne, or Wax Bean.  This edition includes rules for up to seven players, like the Erweiterungs-Set, but also adapts the two-player rules of Al Cabohne in order to allow two people to play Bohnanza.', --description
        1997, --year_published
        13, --age
        45, --play_time_min
        45, --play_time_max
...
(
        ...
        16, --bgg_id
        6.82004, --rating
        'https://cf.geekdo-images.com/thumb/img/RkNqeFmjL2BD0fwtDbEGNmBJu0U=/fit-in/200x150/pic573942.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/WxaZnaBbkRaqUW17Dzg0xyOBMd4=/0x0/pic573942.jpg', --image
        'Economic', --category
...
(
        ...
        20, --bgg_id
        7.47469, --rating
        'https://cf.geekdo-images.com/thumb/img/RqZ6CwJEHShUwFtPI0a4OVSKJbA=/fit-in/200x150/pic451783.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/RJJama3a9_wLenjvKJh58rgxlBE=/0x0/pic451783.jpg', --image
        'Science Fiction', --category
        'Action Points') --mechanic
,
(
        21, --id
        'Gateway to the Stars', --name
        'A 4X game (eXplore, eXpand, eXploit, eXterminate) along the lines of Stellar Conquest, players each control a space faring empire that moves out to other star systems to explore and conquer.', --description
        1994, --year_published
        12, --age
        0, --play_time_min
        0, --play_time_max
...
(
        ...
        22, --bgg_id
        7.17185, --rating
        'https://cf.geekdo-images.com/thumb/img/Lz-oN-BoiBvBrbZ9U94f8VrErnE=/fit-in/200x150/pic148345.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/CeJiWNodJGwBPse17RA6p4krH6c=/0x0/pic148345.jpg', --image
        'Adventure, Exploration, Fantasy', --category
        'Action Queue, Modular Board, Role Playing, Simultaneous Action Selection, Variable Player Powers') --mechanic
,
(
        23, --id
        'Divine Right', --name
        'Classic game of fantasy empires clashing.  Each player controls a unique realm and attempts to use diplomacy and might to ascend to rulership.  A colorful map and a host of fantastic creatures bring out a fleshed out fantasy world.Expanded by:    Divine Right: Scarlet Empire', --description
        1979, --year_published
        12, --age
        360, --play_time_min
        360, --play_time_max
...
(
        ...
        24, --bgg_id
        6.64903, --rating
        'https://cf.geekdo-images.com/thumb/img/5ub28oCmkGHYgt-d00RkEgX5AQU=/fit-in/200x150/pic857.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/COM3xWJeoqoM5PXSwjRCjujM1cI=/0x0/pic857.jpg', --image
        'Civilization, Negotiation, Political, Science Fiction, Space Exploration, Wargame', --category
        'Dice Rolling, Hexagon Grid, Modular Board, Tile Placement, Variable Player Powers, Voting') --mechanic
,
(
        25, --id
        'Battlemist', --name
        'In this fantasy relative to Twilight Imperium, players control races that must juggle military and economic concerns with a quest to gather the magical stars spread across the land.  The game board is made up of hex tiles and players use a resource system that has similarities to The Settlers of Catan.  A card driven system resolves players quests.Expanded by:    Battlemist: The Sails of WarReimplemented by:    Runewars', --description
        1998, --year_published
        12, --age
        200, --play_time_min
        200, --play_time_max
...
(
        ...
        26, --bgg_id
        7.09914, --rating
        'https://cf.geekdo-images.com/thumb/img/X8XywCNXpWIi2aGIHAVw_BvVunA=/fit-in/200x150/pic87721.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/Uvu0ANX4_XaHXOdtZ79gpz9VI8Q=/0x0/pic87721.jpg', --image
        'Civilization, Economic, Medieval, Renaissance', --category
        'Area Movement, Auction/Bidding') --mechanic
,
(
        27, --id
        'Supremacy', --name
        'Supremacy pits conventional superpowers against one another for control of the earth.  Along the lines of modern warfare Risk, only with an integrated supply/demand economic system.  Warfare comes in all forms from conventional, biological, chemical and all the way to nuclear.  Neat little plastic mushroom clouds are included to show where regions of the earth have been blasted, and if nuclear winter occurs, all players lose.  The game also spawned a great many supplements to expand the game further.', --description
        1984, --year_published
        12, --age
        340, --play_time_min
        340, --play_time_max
...
(
        ...
        28, --bgg_id
        6.50802, --rating
        'https://cf.geekdo-images.com/thumb/img/5tVxbGMvGDvaYd8uVOeu-nPowt8=/fit-in/200x150/pic4206838.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/Spqi-g9bDkzjrIcvMKmY8eRnsJc=/0x0/pic4206838.jpg', --image
        'Card Game, Humor, Negotiation, Political, Science Fiction', --category
        'Card Drafting, Dice Rolling, Network and Route Building, Tile Placement, Variable Player Powers') --mechanic
,
(
        29, --id
        'Terrain Vague', --name
        'Having many system similarities to Full Metal PlanÃ¨te, Terrain Vague is a war game-ish game based on young gangs of kids fighting over turf in a junk yard.  Imagine a R-rated Little Rascals movie with weapons and you get the idea.A winner of the 1992 Concours International de CrÃ©ateurs de Jeux de SociÃ©tÃ©.', --description
        1993, --year_published
        10, --age
        120, --play_time_min
        120, --play_time_max
...
(
        ...
        30, --bgg_id
        6.7298, --rating
        'https://cf.geekdo-images.com/thumb/img/H3ZnI3miTIjOHTqnHEaePt3C0ig=/fit-in/200x150/pic204975.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/rlDTeYUHEmTPQiCR-Z51lTd0JFk=/0x0/pic204975.jpg', --image
        'Adventure, Electronic, Exploration, Fantasy, Fighting', --category
        'Area Movement, Push Your Luck') --mechanic
,
(
        31, --id
        'Dark World', --name
        'Along the lines of HeroQuest comes a much more heavily produced game called Dark World. One player is the evil lord who controls the dungeon in which the rest of the players move their characters from room to room, fighting monsters and gaining treasure. Real working treasure chests with magic weapons inside and the figures even get to put their new weapons in their characters hands.', --description
        1991, --year_published
        10, --age
        90, --play_time_min
        90, --play_time_max
        31, --bgg_id
        5.27036, --rating
        'https://cf.geekdo-images.com/thumb/img/iGJDAfuDrT40OIU7WU7FxKA_A4s=/fit-in/200x150/pic525738.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/ILdFE-JACp1c0N1HgKGZPL8rmdU=/0x0/pic525738.jpg', --image
        'Adventure, Exploration, Fantasy, Fighting, Miniatures', --category
        'Dice Rolling, Grid Movement') --mechanic
,
(
        32, --id
        'Buffalo Chess', --name
        'In Buffalo Chess, a.k.a. Bison, one player represents Indians who are trying to keep the village from being overrun by buffalo. This player moves the Indian chief and his dogs while the other player takes charge of the herd of rampaging buffalo, all of which are represented by nice little wooden pieces. Each side has its own style of play as the pieces move differently.', --description
        1975, --year_published
        8, --age
        30, --play_time_min
        30, --play_time_max
        32, --bgg_id
        6.12531, --rating
        'https://cf.geekdo-images.com/thumb/img/GO6xPlP_uu7Mbul9-1uv7CUwCIU=/fit-in/200x150/pic4604213.jpg', --thumbnail
        'https://cf.geekdo-images.com/original/img/HfDcUODgpHiTpcgg-XbaK96T4pg=/0x0/pic4604213.jpg', --image
        'Abstract Strategy, American West', --category
        '') --mechanic
;
